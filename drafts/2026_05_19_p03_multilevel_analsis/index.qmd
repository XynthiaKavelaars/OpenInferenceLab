...
*This vignette is part of the `bmco()` package and can be found [here](https://cran.r-project.org/web/packages/bmco/vignettes/multilevel-models.html)*
...
For inverse-Wishart priors: - Gelman, A. (2006). Prior distributions for variance parameters in hierarchical models. *Bayesian Analysis, 1*(3), 515-534. \doi{10.1214/06-BA117A}
...
`r format_apa(bib[["Kavelaars2023"]])`
